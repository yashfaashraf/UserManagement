...
namespace backend_dotnet9.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("users")]
        public async Task<ActionResult<IEnumerable<UserInfoResultDto>>> GetUsersList()
        {
        ...
        public async Task<ActionResult<UserInfoResultDto>> GetUserDetailsByUserName([FromRoute] string userName)
        {

...
//Role Access Arrays
//To define which roles have access to which parts of the app.
//Everyone can access.
...
//isAuthorizedForUpdateRole('ADMIN', 'USER'); // ✅ true
//isAuthorizedForUpdateRole('ADMIN', 'OWNER'); // ❌ false
//isAuthorizedForUpdateRole('OWNER', 'OWNER'); // ❌ false
